...
This is initially developed by myself (Jeffrey K L Wong) and Bill K K Chan as the final project of the course - Fundamentals of Operating Systems during our Master Study in HK Polytechnic University. The program was written using Xcode7.0 and fully tested on Mac OSX 10.10.4 with Apple LLVM compiler (clang-700.0.72). At the time of the project we haven't been able to port it to Linux and this is the enhancement we are currently wordking on to bring the support to GCC compiler.
